...
FileList = 'Armor.psd1', 'Armor.psm1', 'Private\ConvertFrom-JsonXL.ps1', 
               ...
               'Private\Test-ArmorConnection.ps1', 
               'Private\Update-ArmorApiToken.ps1', 'Public\Connect-Armor.ps1', 
               'Public\Disconnect-Armor.ps1', 'Public\Get-ArmorAccount.ps1', 
               'Public\Get-ArmorDatacenter.ps1', 'Public\Get-ArmorUser.ps1', 
               'Public\Get-ArmorVm.ps1', 'Public\Rename-ArmorVM.ps1', 
               'Public\Reset-ArmorVM.ps1', 'Public\Restart-ArmorVM.ps1', 
               'Public\Set-ArmorAccountContext.ps1', 'Public\Start-ArmorVM.ps1', 
               'Public\Stop-ArmorVM.ps1'

...
FileList = 'Armor.psd1', 'Armor.psm1', 
               ...
               'Public/Get-ArmorDatacenter.ps1', 
               'Public/Get-ArmorUser.ps1', 'Public/Get-ArmorVm.ps1', 
               'Public/Rename-ArmorVM.ps1', 'Public/Reset-ArmorVM.ps1', 
               'Public/Restart-ArmorVM.ps1', 
               'Public/Set-ArmorAccountContext.ps1', 
               'Public/Start-ArmorVM.ps1', 'Public/Stop-ArmorVM.ps1'

...
Properties {
    ...
    $TEXT += @{
        ...
        "Every code push is built using psake on $( $TEXT.Windows ) via $( $TEXT.AppVeyor ), as well as on $( $TEXT.macOS ) and $( $TEXT.Ubuntu ) via $( $TEXT.TravisCi ), and tested using the $( $TEXT.Pester ) test and mock framework.",
